...
def main():
    ...
    szalloda.foglalas("101", datetime(2024, 5, 1))
    szalloda.foglalas("201", datetime(2024, 5, 2))
    szalloda.foglalas("201", datetime(2024, 5, 3))
    szalloda.foglalas("202", datetime(2024, 5, 2))
    szalloda.foglalas("202", datetime(2024, 5, 3))
